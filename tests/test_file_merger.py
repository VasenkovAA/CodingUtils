...
class TestGitIgnoreParser:
    ...
    def test_should_ignore_no_patterns(self):
        ...
        assert not parser.should_ignore(file_path, root_dir)
    ...
    def test_should_ignore_pattern_matching(self, temp_dir, gitignore_content):
        ...
        assert parser.should_ignore(temp_dir / "test.log", temp_dir)
        assert parser.should_ignore(temp_dir / "module.pyc", temp_dir)
        assert parser.should_ignore(temp_dir / "test_example.py", temp_dir)
        assert not parser.should_ignore(temp_dir / "main.py", temp_dir)
        assert not parser.should_ignore(temp_dir / "README.md", temp_dir)
    ...
    def test_matches_pattern_with_directory(self):
        ...
        assert parser._matches_pattern(rel_path, pattern)
...
class TestFileMerger:
    ...
    def test_should_exclude_gitignore(self, temp_dir):
        ...
        assert merger.should_exclude(file_path)
    ...
    def test_should_exclude_by_directory(self, temp_dir):
        ...
        assert not merger.should_exclude(file_path2)
    ...
    def test_should_exclude_by_name(self):
        ...
        assert merger.should_exclude(Path("test.tmp"))
        assert merger.should_exclude(Path("temp_file.txt"))
        assert not merger.should_exclude(Path("normal.txt"))
    ...
    def test_should_exclude_by_pattern(self):
        ...
        assert merger.should_exclude(Path("test_example.py"))
        assert merger.should_exclude(Path("src/tmp/file.txt"))
        assert not merger.should_exclude(Path("main.py"))
